...
import { CurrencyDollarIcon, ChartBarIcon } from '@heroicons/vue/20/solid'
                    ...
                    <div class="w-full flex-auto">
                        ...
                        <ul role="list" class="mt-10 grid grid-cols-1 gap-x-8 gap-y-3 text-base leading-7 text-white sm:grid-cols-2">
                            <li class="flex gap-x-3">
                                <CurrencyDollarIcon class="h-7 w-5 flex-none" aria-hidden="true" />
                                Revenue (in billions) : {{ restaurant.revenue }}
                            </li>

                            <li class="flex gap-x-3">
                                <ChartBarIcon class="h-7 w-5 flex-none" aria-hidden="true" />
                                Number of Stores : {{ restaurant.numberOfStores }}
                            </li>
                        </ul>
