...
<template>
    ...
    <div class="bg-white relative isolate overflow-hidden dark:bg-gray-900 ">
        <svg class="absolute inset-0 -z-10 h-full w-full stroke-white/10 [mask-image:radial-gradient(100%_100%_at_top_right,white,transparent)]"
            ...
            <svg x="50%" y="-1" class="overflow-visible fill-white dark:fill-gray-800/20">
        ...
        <div class="mx-auto max-w-7xl px-6 pb-24 pt-10 sm:pb-32 lg:flex lg:px-8 lg:py-40">
            <div class="mx-auto max-w-2xl flex-shrink-0 lg:mx-0 lg:max-w-xl lg:pt-8">
              ...
              <ChevronRightIcon class="h-5 w-5 text-gray-500" aria-hidden="true"/>
                ...
                <h1 class="mt-10 text-4xl font-bold tracking-tight text-gray-600 sm:text-6xl dark:text-white">Deploy to the cloud with
                    confidence</h1>
                <p class="mt-6 text-lg leading-8 text-gray-900 dark:text-gray-300">Anim aute id magna aliqua ad ad non deserunt sunt. Qui
                ...
                <div class="mt-10 flex items-center gap-x-6">
                    <a href="#"
                       class="rounded-md bg-indigo-500 px-3.5 py-2.5 text-sm font-semibold text-white shadow-sm hover:bg-indigo-400 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-400">Get
                        started</a>
                    <a href="#" class="text-sm font-semibold leading-6 text-gray-600 dark:text-white">Learn more <span
